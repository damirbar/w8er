...
public class ViewPagerAdapter extends PagerAdapter {
     ...
     */
    public ViewPagerAdapter(Activity activity, ArrayList<Pictures> dataSet, Toolbar toolbar, RecyclerView imagesHorizontalList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String o = mDataSet.get(position).getUrl();
        boolean isImageValid;
        imageView = (ImageView) itemView.findViewById(R.id.iv);

        if (Utility.isValidURL(o)) {
            Glide.with(activity)
                    .load(String.valueOf(mDataSet.get(position).getUrl()))
