...
//
//public class ReviewsAdapter_pull_test extends RecyclerView.Adapter<ReviewsAdapter_pull_test.ViewHolder> {
//
...
//    public ReviewsAdapter_pull_test(Context context, List<Review> data) {
